...
class UserORMHelperTestCase(unittest.TestCase):
    ...
    def test_query_one_name_password(self):
        # 查询一个相同name，password数据测试
         ...
         isSuccess=self.helper.addUser(Users("tome", "tom jobn3"))
         self.assertTrue(isSuccess)
         userList=self.helper.query_first_name_password(Users("tome", "tom jobn"))
         # print userList
    ...
    def test_query_all_name_password(self):
        # 查询所有相同name，password数据测试
         ...
         isSuccess=self.helper.addUser(Users("tome", "tom jobn3"))
         self.assertTrue(isSuccess)
         userList=self.helper.query_all_with_user_name_password(Users("tome", "tom jobn"))
    ...
    def test_revise_extra(self):
        ...
        self.assertTrue(isSuccess)
        userList = self.helper.query_all_with_user_name_password(Users("tome", "tomUpdate"))
        self.assertEqual(len(userList), 1)
